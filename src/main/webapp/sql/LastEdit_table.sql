...
-- 배송 상태 테이블(d_status_num : 0:결제완료 1:배송준비중 2:배송중 3:배송완료 4:구매확정 5:반품 6:교환 7:주문취소)
...
(
    ...
    order_no         VARCHAR2(50)           NOT NULL, 
    d_status_num     NUMBER(1,0)      DEFAULT 0 NOT NULL, 
    tracking_num     NVARCHAR2(20)    NULL,
